...
import styles from "./NovaPostForm.module.css";
import {useState} from "react";
import * as yup from "yup";
import Space from "../Wrapper/Wrapper";
import CitySelect from "../Select/Select";
        ...
        <Box className={styles.mainBox}>
            <FormProvider {...{register, handleSubmit, errors}}>
                <form onSubmit={handleSubmit(onSubmit)} onReset={onReset} className={styles.form}>
                    ...
                    <div className={styles.row}>
                        <div className={styles.checkBox}>
                            <input id="palletizing" type="checkbox" {...register(`palletization`)}/>
